...
export class FakeDbService {
  ...
  createTrips() {
    const fakeTrips: Array<Trip> = [
      ...
      new Trip(7, 'Gastro Wrocław', 'Wrocław', new Date(2019, 2, 7), new Date(2019, 2, 12), 2500, "Podróż po najlepszych restauracjach i knajpach we Wrocławi", "Wrocław", 15, 1, false, 0, 3.42,  "http://tu.url.do.zdjęcia.html"),
      ...
      new Trip(16, 'Gastro Wrocław', 'Wrocław', new Date(2019, 4, 7), new Date(2019, 4, 12), 2500, "Podróż po najlepszych restauracjach i knajpach we Wrocławi", "Wrocław", 15, 15, false, 0, 3.42,  "http://tu.url.do.zdjęcia.html"),
      ...
      new Trip(24, 'Super Warszawa',  'Warszawa', new Date(2019, 6, 5), new Date(2019, 6, 10), 700, 'Poznaj warszawe od zupełnie innej strony',  'Warszawa',  15, 0, false, 0, 3.42,  "http://tu.url.do.zdjęcia.html"),
